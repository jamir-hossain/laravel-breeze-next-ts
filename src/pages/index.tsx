...
const Home = () => {
  ...
  // const { data, error } = useQuery("products", () => fetcher("/api/products"));
  // console.log(data);
  ...
  //       headers: {
  //         Authorization: `Bearer 1|xUpsF21JkpyNrQahfartPkGFNEHQqiIxuMzUcebp`,
  //       },
  //     }),
  //   {
  //     onSuccess(data) {
    ...
    >
      <div className="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        {user ? (
          ...
          <>
            <NextLink href="/login" className="ml-4 text-sm underline">
              Login
            </NextLink>
            <NextLink href="/register" className="ml-4 text-sm underline">
              Register
            </NextLink>
          </>
        )}
      ...
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        {user && <NextLink href="/dashboard">Dashboard</NextLink>}
      </div>
    </div>
  );
};
